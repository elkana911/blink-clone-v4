 ...
 */
    ...
    BlinkIdScanner.prototype.scanIDCard = function (successCallback, errorCallback, types, imageType, licenseiOs, licenseAndroid) {
        ...
        exec(successCallback, errorCallback, 'BlinkIdScanner', 'scanIDCard', [types, imageType, licenseiOs, licenseAndroid]);
    };
